...
const CheckoutForm = (props) => {
  //Moved the constants below to useForm.js
  /*
  const [showSuccessMessage, setShowSuccessMessage] = useState(false);
  const [values, setValues] = useForm(initialValue);
  */
  //Passed in the above constants from useForm.js as one array below:
  const [showSuccessMessage, setShowSuccessMessage, values, handleChanges] = useForm(initialValue);

  /* //Moved handleChanges to useForm.js
